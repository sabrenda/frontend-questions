...
## 18. Как поменять контекст функции? call, bind, apply [🔼](#menu)
...
## 19. Что такое тернарный оператор? [🔼](#menu)
...
## 20. Что такое деструктуризация? [🔼](#menu)
...
## 21. Какие способы работы с асинхронным кодом вы знаете? [🔼](#menu)
...
## 22. e.preventDefault() и e.stopPropagination() для чего нужны? [🔼](#menu)
...
## 23. Как отслеживать и обрабатывать ошибки в javascript? [🔼](#menu)
...
## 25. Что такое цикл событий (event loop) и как он работает? [🔼](#menu)
...
В основе своей, Event Loop - это бесконечный цикл, который слушает входящие события и запускает соответствующий код для их обработки.
...
## 26. Что такое прототипное наследование? [🔼](#menu)
...
## 27. Как получить свойство объекта? [🔼](#menu)
...
## 28. Всплытие и погружение событий [🔼](#menu)
...
## 29. Optional chaining оператор. Для чего нужен? [🔼](#menu)
...
## 31. function expression и function declaration. Что это такое и в чем разница? [🔼](#menu)
...
## 32. Для чего нужны полифилы? [🔼](#menu)
...
## 33. Расскажите о функциях - конструкторах [🔼](#menu)
...
## 34. Как можно получить список полей и список значений объекта [🔼](#menu)
...
## 35. Как сделать наследование класса в ES6 [🔼](#menu)
...
## 36. Микро и макро таски в JavaScript [🔼](#menu)
...
## 37. Что такое генераторы в javascript и как они работают [🔼](#menu)
...
## 38. Какие способы хранения данных в браузере вы знаете? [🔼](#menu)
...
## 39. В чем отличие sessionStorage от localStorage? [🔼](#menu)
...
## 40. Что такое анонимная функция? [🔼](#menu)
...
## 41. Как сервер может запретить чтение cookie из браузера? [🔼](#menu)
...
## 42. Что представляют из себя регулярные выражения и для чего они нужны? [🔼](#menu)
...
## 43. WeakSet и WeakMap отличие от Map и Set? [🔼](#menu)
...
## 44. Почему два объекта с одинаковыми полями при сравнении дают false? [🔼](#menu)
...
## 45. Почему у примитивов (number,string …) мы можем вызывать методы? Например ‘some string’.toLowerCase()? [🔼](#menu)
...
## 46. Как проверить из какого класса был создан объект? [🔼](#menu)
...
## 47. Напишите код, который будет выводить в логи каждые 5 секунд время пребывания на сайте в секундах.? [🔼](#menu)
...
## 48. Как остановить интервал? [🔼](#menu)
...
## 49. Что представляет из себя чистая функция? [🔼](#menu)
...
## 50. Что представляет из себя функция высшего порядка? [🔼](#menu)
...
## 51. Зачем нужны промисы, если можно работать с асинхронным кодом с помощью функций обратного вызова (callbacks)? [🔼](#menu)
...
## 52. Что будет, если добавить скрипт перед тегом body? [🔼](#menu)
...
## 53. Как проверить, является ли объект массивом? [🔼](#menu)
...
## 54. Что такое рекурсия? Как предотвратить бесконечную рекурсию? [🔼](#menu)
...
## 55. Что такое статический метод класса (static)? [🔼](#menu)
...
## 56. Что такое «strict» mode в JS? [🔼](#menu)
...
## 57. Mutable vs Immutable в JS  [🔼](#menu)
...
## 58. Что такое типизированный язык? [🔼](#menu)
...
## 59. Что такое подъем или hoisting? [🔼](#menu)
...
## 60. Что такое делегирование событий в JS? [🔼](#menu)
...
## 61. В чем разница между host и native объектами? [🔼](#menu)
...
## 62. Что такое функция карри? [🔼](#menu)
...
## 65. Что такое Content Security Policy (CSP) [🔼](#menu)
...
## 66. Что такое Cross-Site Scripting (XSS) [🔼](#menu)
...
## 67. Различия между старым js и новым js [🔼](#menu)
