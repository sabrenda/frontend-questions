...
|31| [Какие методы жизненного цикла компонента существуют в React?](#react31)|
|32| [Что такое Context в React и для чего он используется?](#react32)|
|33| [Как работает проп children?](#react33)|
|34| [Что такое PureComponent?](#react34)|
|35| [Что такое Компонент высшего порядка (Higher-Order Component, HOC)?](#react35)|
|36| [Что такое хуки в React?](#react36)|
|37| [Что такое порталы в React?](#react37)|
|38| [Что такое React Reconciliation (Cверка) и как он работает?](#react38)|
|39| [Можно создавать анимации в React?](#react39) |
|40| [Flux-архитектура, Redux и MobX: Что такое Flux - архитектура? Какие сущности она имеет?](#react40) |
...
## 7 Какие React хуки вы знаете и используете
...
## 31 Какие методы жизненного цикла компонента существуют в React?
...
## 32 Что такое Context в React и для чего он используется?
...
## 35 Что такое Компонент высшего порядка (Higher-Order Component, HOC)?
...
## 38 Что такое React Reconciliation (Cверка) и как он работает?
...
## 39 Можно создавать анимации в React?
...
## 40 Flux-архитектура, Redux и MobX: Что такое Flux - архитектура? Какие сущности она имеет?
