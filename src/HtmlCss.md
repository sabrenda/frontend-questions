...
|3|[Какие бывают значения у свойства Position? ```Static```, ```Relative```, ```Absolute```, ```Fixed```, ```Sticky```](#css3)|
...
|57|[Margin vs padding, схлопывание margin](#css57)|
|58|[Зачем нужны `media query`](#css58)|
|59|[Отличия Div от Span](#css59)|
|60|[Почему transform лучше для анимаций чем top,left](#css60)|
|61|[Атрибуты для lazy подгрузки медиа в хтмл](#css61)|
|62|[Когда происходит Reflow Repaint](#css62)|
|63|[Что такое CSSOM](#css63)|
|64|[Что такое Shadow DOM](#css64)|
|65|[гидратация](#css65)|
...
## 3. Какие бывают значения у свойства Position? ```Static```, ```Relative```, ```Absolute```, ```Fixed```, ```Sticky```
...
## 57. Margin vs padding, схлопывание margin
...
```css
/* Стили для экранов шириной до 600px (обычно мобильные устройства) */
@media (max-width: 600px) {
  body {
    font-size: 14px;
...
/* Стили для экранов шириной от 601px до 1200px (планшеты и небольшие экраны) */
...
## 60. Почему transform лучше для анимаций чем top,left
...
## 61. Атрибуты для lazy подгрузки медиа в хтмл
...
## 62. Когда происходит Reflow Repaint
