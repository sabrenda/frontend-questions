...
|2| [Что такое типизированный язык?](#2)|
|3| [Что такое подъем или hoisting?](#3)|
|4| [Что такое «strict» mode в JS?](#4)|
|5| [В чем разница между операторами `==` и `===`?](#5)|
|6| [В чем разница между null и undefined?](#6)|
|7| [Что такое тернарный оператор? **(true ? 'yes' : 'no')**](#7)|
|8| [Что такое **new Set()** и **new Map()**?](#8)|
|9| [Какие значения являются falsy(ложными) значениями? **(false, 0, "", undefined, null, NaN)**](#9)|
|10| [Почему typeof массива === object](#10)|
|11| [Для чего нужен оператор **[...spread]**?](#11)|
|12| [Что такое Promise? **({}, Pending, Fulfilled, Rejected)**](#12)|
|13| [методы экземпляра Promise и статические методы Promise](#13)|
|14| [Что такое **async/await**?](#14)|
|15| [Какие способы работы с асинхронным кодом вы знаете? **(Callbacks, Promises, Async/Await)**](#15)|
|16| [Что такое **event loop** (цикл событий)?](#16)|
|17| [Что такое мемоизация и кеширование?](#73)|
|  | <h3>Переменные и функции</h3> |
|18| [Отличия **var**, **let** и **const**?](#3)|
|19| [Что такое функция первого класса?](#91)|
|20| [Стрелочные функции и их отличие от функций, объявленных через function **(синтаксис, this, args)**](#6)|
|21| [function expression и function declaration. Что это такое и в чем разница?](#31)|
|22| [Что такое анонимная функция?](#40)|
|23| [Что такое IIFE (Самовызывающиеся функции)?](#81)|
|24| [Что такое чистая функция?](#49)|
|25| [Что такое функция высшего порядка?](#50)|
|26| [Что такое каррирование (функция карри)?](#62)|
|27| [Как отслеживать и обрабатывать ошибки в JavaScript? **Try/Catch/Finally**](#23)|
|28| [Что такое рекурсия? Как предотвратить бесконечную рекурсию?](#54)|
|  | <h3>Объекты и прототипы:</h3> |
|29| [Что такое прототипное наследование?](#26)|
|30| [Что такое **прототип** объекта в JavaScript? **Prototype**](#5)|
|31| [Какие способы создания объекта вы знаете?](#11)|
|32| [Как сделать объект неизменяемым, методы `Object.freeze`, `Object.seal`, `Object.defineProperty`](#85)|
|33| [Что такое деструктуризация? **(let [a, b, c] = arr;**, **let { name, age } = obj)**](#20)|
|34| [Как определить наличие свойства в объекте? **hasOwnProperty**](#10)|
|35| [Как получить свойство объекта? **Object.keys, Object.values, Object.entries**](#27)|
|36| [Дескрипторы свойств объекта](#77)|
|37| [Что такое объект `Proxy`](#89)|
|38| [Как работает ключевое слово new?](#87)|
|39| [Как сделать наследование класса в ES6?](#35)|
|40| [Конструкторы, constructor](#86)|
|41| [Как проверить, из какого класса был создан объект?](#46)|
|42| [Что такое статический метод класса (static)?](#55)|
|43| [Почему два объекта с одинаковыми полями при сравнении дают false?](#44)|
|44| [Что такое делегирование событий в JS?](#60)|
|45| [Как удалить ключ у объекта?](#82)|
|46| [Зачем нужен `instanceof`?](#83)|
|  | <h3>Работа с событиями:</h3> |
|47| [**e.preventDefault()** и **e.stopPropagation()**, **e.stopImmediatePropagation** для чего нужны?](#22)|
|48| [Всплытие и погружение событий. **Всплытие (bubbling), Погружение (capturing)**](#28)|
|49| [Отличие Event.target от event.currentTarget](#75)|
|50| [Что такое Optional chaining? **(user?.address?.street)**](#29)|
|51| [Что такое throttle и debounce?](#72)|
|52| [Как остановить интервал? **clearInterval(intervalId);**](#48)|
|  | <h3>Асинхронность и запросы:</h3> |
|53| [Что такое **requestAnimationFrame**?](#97)|
|54| [**requestIdleCallback**](#98)|
|55| [**fetch()**](#99)|
|56| [**AbortController()**](#100)|
|57| [Какие есть способы для работы с запросами в React?](#101)|
|58| [Как сервер может запретить чтение cookie из браузера? **(флаг HttpOnly)**](#41)|
|  | <h3>Массивы и строки:</h3> |
|59| [Методы массивов в JavaScript](#68)|
|60| [Методы строк в JavaScript](#69)|
|61| [Как проверить, является ли объект массивом?](#53)|
|  | <h3>Локальное хранение данных:</h3> |
|62| [Какие способы хранения данных в браузере вы знаете? **(LocalStorage, sessionStorage, Cookies, IndexedDB)**](#38)|
|63| [В чем отличие sessionStorage от localStorage?](#39)|
|  | <h3>Разное:</h3> |
|64| [Сборщик мусора](#96)|
|65| [Shadow DOM](#30)|
|66| [WeakSet и WeakMap: отличие от Map и Set](#43)|
|67| [Что такое регулярные выражения?](#42)|
|68| [Зачем нужны полифилы?](#32)|
|69| [Что такое Service Worker?](#92)|
|70| [Что такое Web Worker?](#93)|
|71| [Что такое ECMAScript?](#71)|
|72| [Что такое ES Модуль?](#94)|
|73| [Что такое катаморфизмы?](#64)|
|74| [Что такое анаморфизмы?](#63)|
|75| [Что такое Compose?](#90)|
|76| [Различия между старым JS и новым JS](#67)|
|77| [Разница между `<script>`, `<script async>` и `<script defer>`](#88)|
|78| [Какие структуры данных существуют и какова сложность алгоритмов?](#84)|
|79| [Как дебажить приложение и причины утечек памяти?](#104)|
|80| [Как избежать ссылочной зависимости при копировании объекта? Глубокое копирование объекта **(JSON.parse(JSON.stringify(orig)), Lodash, recursion)**](#16)|
|81|
|82| [Как проверить, является ли объект массивом?](#53)|
|83| [Структуры данных в JavaScript](#84)|
|84| [Различия между host и native объектами?](#61)|
|85| [Что такое Shadow DOM?](#30)|
|86| [Операторы логического присваивания](#80)|
|87| [Что такое генераторы в JavaScript и как они работают?](#37)|
|88| [Микро и макро задачи в JavaScript](#36)|
|89| [Ключевое слово `super`](#65)|
|90| [Что такое Static метод?](#55)|
|91| [Mutable vs Immutable в JS](#57)|
|92| [Что такое дескрипторы свойств?](#77)|
|93| [Зачем нужны промисы, если можно работать с асинхронным кодом с помощью функций обратного вызова (callbacks)?](#51)|
|94| [Что будет, если добавить скрипт перед тегом body?](#52)|
|95| [Как ты будешь дебажить приложение, из-за чего бывают утечки памяти?](#104)|
|96| [Что такое Intl в JavaScript?](#102)|
|97| [Что такое статическое свойство класса (static)](#55)|
|98| [Какие особенности есть у JavaScript?](#95)|
|99| [Что такое AbortController?](#100)|
|100| [Intl - интернационализация в JavaScript](#102)|
|101| [Методы статического объекта](#79)|
|102| [Методы массивов](#68)|
|103| [Методы строк](#69)|
|104| [Что такое Event.target и event.currentTarget](#75)|
